...
public class EditStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(43, 42, 76)));
        jPanel1.setPreferredSize(new java.awt.Dimension(800, 500));
        jPanel1.setLayout(new org.netbeans.lib.awtextra.AbsoluteLayout());

        jLabel2.setIcon(new javax.swing.ImageIcon("C:\\Users\\Ashish\\Downloads\\learning3.png")); // NOI18N
        jLabel2.setText("jLabel2");
        jPanel1.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 30, 79, 72));
        ...
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 100, 210, 30));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(310, 130, 210, 10));
        ...
        jPanel1.add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 140, 60, 40));
        jPanel1.add(jSeparator2, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 230, 270, 20));
        ...
        jPanel1.add(t1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 200, 270, 30));
        ...
        jPanel1.add(t2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 200, 170, 30));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 230, 170, 20));
        ...
        jPanel1.add(t3, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 250, 270, 30));
        jPanel1.add(jSeparator4, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 280, 270, 20));
        ...
        jPanel1.add(t4, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 250, 170, 30));
        jPanel1.add(jSeparator5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 280, 170, 20));
        ...
        jPanel1.add(co1, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 310, 270, 30));
        ...
        jPanel1.add(co2, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 310, 170, 30));

        t5.setBackground(new java.awt.Color(43, 42, 76));
        ...
        jPanel1.add(t5, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 360, 550, 30));
        jPanel1.add(jSeparator6, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 390, 550, 20));
        ...
        jPanel1.add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 420, 110, 40));
        ...
        jPanel1.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 420, 100, 40));
    ...
    private void t3FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_t3FocusGained
        // TODO add your handling code here:
        if(t3.getText().equals("Parent's Name"))
        {
            t3.setText("");
        }
    ...
    private void t4FocusGained(java.awt.event.FocusEvent evt) {//GEN-FIRST:event_t4FocusGained
        // TODO add your handling code here:
        if(t4.getText().equals("Parent's Mobile"))
        {
            t4.setText("");
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try
        {
            ...
            String Sem=co2.getSelectedItem().toString();
            String Branch=co1.getSelectedItem().toString();
            String Pname=t3.getText();
            String Pmobile=t4.getText();
            String Address=t5.getText();
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ctproject","root","");
            String q="update student set name='"+Name+"',branch='"+Branch+"',sem='"+Sem+"',mobile='"+Mobile+"',pname='"+Pname+"',pmobile='"+Pmobile+"',address='"+Address+"'";
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        try
        {
            ...
            Class.forName("com.mysql.jdbc.Driver");
            Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/ctproject","root","");
            String q="delete from student where roll_no='"+x+"'";
           Statement stmt=con.createStatement();
           int rs=stmt.executeUpdate(q);
           while(rs!=0)
           {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
           ...
           while(rs.next())
           {
               ...
               t4.setText(rs.getString("pmobile"));
               t5.setText(rs.getString("address"));
               co1.setSelectedItem(rs.getString("branch"));
               co2.setSelectedItem(rs.getString("sem"));
           }   
           con.close();
        }
        catch(Exception ex)
